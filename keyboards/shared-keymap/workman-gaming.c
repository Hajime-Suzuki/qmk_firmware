...
#define _SHORTCUTS 8
#define _FL1_clone 9
#define _LED_SOUND 10
#define _BRAWLHALLA 11
#define _FORTNITE 12
...
[_BL] = KEYMAP(
  ...
  KC_ENT,  MO(_LEFT_NUM), KC_ESC,  KC_TAB, KC_SPC, MO(_FL1),   OSM(MOD_LSFT), LT(_NUM, KC_BSPC), KC_DEL, KC_APP, MO(_LED_SOUND), S(LCMD(KC_F9))
),
...
[_BRAWLHALLA] = KEYMAP(
  ...
  _______, _______    , KC_B, KC_TAB      , KC_SPC         , KC_SPC,        MO(_FL2)     , LT(_NUM, KC_BSPC), KC_SPC     , _______         ,  MO(_LED_SOUND), _______
),
...
[_FORTNITE] = KEYMAP(
  ...
  KC_TAB   , KC_A, KC_S, KC_H, KC_T, KC_G,       KC_Y, KC_N, KC_E   , KC_O  , KC_I       , KC_MINS,
  KC_ESC   , KC_Z, KC_V, KC_M, KC_C, KC_X,       KC_K, KC_L, KC_COMM, KC_DOT, KC_SLSH    , KC_LCTL,
  _______, _______    , KC_F, KC_TAB      , KC_SPC         , MO(_FL1),        MO(_FL2)     , LT(_NUM, KC_BSPC), KC_SPC     , _______         ,  MO(_LED_SOUND), TO(_BL)
),
...
[_LED_SOUND] = KEYMAP(
  ...
  xxxxx  ,     RGB_M_P,     RGB_M_B ,    RGB_M_SW,      RGB_M_SN,      RGB_M_R ,                RGB_M_K,     RGB_M_X,     RGB_M_G ,    xxxxx  ,      xxxxx   ,      TG(_FORTNITE)  ,
